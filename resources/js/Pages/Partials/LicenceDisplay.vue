...
defineEmits(['update-subscription', 'cancel-subscription']);
...
<template>
  <div>
      ...
      <div class="flex">
        ...
        <JetSecondaryButton :title="$t('Copy licence into your clipboard')" @click.prevent="copyIntoClipboard(licence.key)">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" class="w-4 mr-1">
              ...
              <g><path d="M9.5,1.5H11a1,1,0,0,1,1,1v10a1,1,0,0,1-1,1H3a1,1,0,0,1-1-1V2.5a1,1,0,0,1,1-1H4.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path><rect x="4.5" y="0.5" width="5" height="2.5" rx="1"
                fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></rect><line x1="4.5" y1="5.5" x2="9.5" y2="5.5" fill="none"
                stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></line><line x1="4.5" y1="8" x2="9.5" y2="8" fill="none"
                stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></line><line x1="4.5" y1="10.5" x2="9.5" y2="10.5" fill="none"
                stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></line></g>
              </g>
            </svg>
            {{ $t('Copy') }}
        </JetSecondaryButton>
    ...
    <p class="mb-4 flex items-center dark:text-gray-300">
    ...
    <p>
      <JetSecondaryButton @click="$emit('update-subscription')" class="mr-2">
      ...
      <JetSecondaryButton @click="$emit('update-subscription')">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
